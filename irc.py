...
# Update by Daniel Hyuuga: Tweaked the lib to automatically remove cmd from message
################################################################
...
class IRCConnection(object):
    ...
    def new_nick(self):
        ...
        log.info("NICK", "%s %s" % (old, self.nick))
        self.register_nick()
